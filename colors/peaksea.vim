...
elseif &background=='dark' 
  ...
  if v:version >= 700
    ...
    hi CursorLine	gui=underline 
    " modify the cursorline (by lymslive's taste)
    hi CursorLine	guifg=NONE	guibg=#636363	gui=NONE
  endif
  ...
  if &t_Co==8 || &t_Co==16
    ...
    if v:version >= 700
      ...
      hi CursorLine	ctermfg=bg	ctermbg=fg   	cterm=none
  ...
  elseif &t_Co==256
    ...
    if v:version >= 700
      ...
      hi CursorLine	cterm=underline 
      " modify the cursorline(by limslive taste)
