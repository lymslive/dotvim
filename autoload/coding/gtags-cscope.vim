...
function! s:GtagsCscope()
    ...
    if g:GtagsCscope_Auto_Map == 1
        ...
        :nnoremap <C-\><CR>       :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
        :nnoremap <C-\><C-\><C-]> :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
        :nnoremap <2-LeftMouse>   :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
        :nnoremap g<LeftMouse>    :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
        :nnoremap <C-LeftMouse>   :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
        " Short cut key
        :nnoremap <C-\><SPACE> :cs find<SPACE>
        :nnoremap <F2> :copen<CR>
        :nnoremap <F3> :cs find d <C-R>=expand("<cword>")<CR>:<C-R>=line('.')<CR>:%<CR>
